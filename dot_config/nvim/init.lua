...
vim.keymap.set('n', '<leader>se', require('telescope').extensions.emoji.emoji, { desc = '[S]earch [E]moji' })
vim.keymap.set('n', '<leader>sH', require('telescope').extensions.http.list, { desc = '[S]earch [H]ttp' })
