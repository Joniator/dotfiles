...
local monitor_secondary = "HDMI-A-1"
local monitor_primary = "DP-3"
...
hl.config({
  general = {
    ...
    col = {
      active_border = { colors = { "#fab387", "#cba6f7" }, angle = 45 },
...
hl.bind("SUPER + O", hl.dsp.workspace.move({ monitor = monitor_primary }))
hl.bind("SUPER + I", hl.dsp.workspace.move({ monitor = monitor_secondary }))
